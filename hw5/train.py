    ...
    for word, i in word_index.items():
        if i < num_words:
            ...
            if embedding_vector is not None:
                ...
                embedding_matrix[i] = embedding_dict.get("dog")
...
cPickle.dump(tokenizer, open(os.path.join("./", "tokenizer.pkl"), "wb"))
#tokenizer = cPickle.load(open(os.path.join("./", "tokenizer.pkl"), 'rb'))
