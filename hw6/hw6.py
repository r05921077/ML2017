...
import sys
df=pd.read_csv(sys.argv[1]+"users.csv", sep=',',header=None,encoding="big5")
age=[]
occ=[]
sex=[]
map= np.zeros((6041,3))
...
df=pd.read_csv(sys.argv[1]+"train.csv", sep=',',header=None,encoding="big5")
ck= -1
cnt= -1
user=[]
movie=[]
...
df=pd.read_csv(sys.argv[1]+"test.csv", sep=',',header=None,encoding="big5")
ck= -1
cnt= -1
user=[]
movie=[]
